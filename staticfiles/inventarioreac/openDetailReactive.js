        ...
        html: `
            <div class="card" style="text-align: left;">
                ...
                <div class="card-body">
                    ...
                    <ul class="list-unstyled">
                        <li><strong>Merck Millipore:</strong> <a href="https://www.merckmillipore.com/CO/es" target="_blank" class="external-link">Click aquí</a></li>
                        <li><strong>Carl Roth:</strong> <a href="https://www.carlroth.com/com/en/" target="_blank" class="external-link">Click aquí</a></li>
                        <li><strong>Echa:</strong> <a href="https://echa.europa.eu/es/home" target="_blank" class="external-link">Click aquí</a></li>
                        <li><strong>PubChem:</strong> <a href="https://pubchem.ncbi.nlm.nih.gov/" target="_blank" class="external-link">Click aquí</a></li>
                    </ul>
                </div>
            </div>
        `,
...
function mostrarAlertaJavaScript(url) {
    const mensaje = `\nSaliendo UniCLab Reactivos...\n\nLa Dirección de Laboratorios de la Universidad Nacional de Colombia sede Manizales no se hace responsable por los contenidos encontrados en webs ajenas a esta.\n\n¿Desea continuar?\n`;
    if (confirm(mensaje)) {
